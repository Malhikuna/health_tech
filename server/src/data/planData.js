...
export const recipesData = [
  { id: 1, name: 'Paket Nasi & Tempe Bakar', description: 'Kombinasi protein nabati dari tempe dengan karbohidrat kompleks dari nasi merah...', instructions: '1. Haluskan {Bawang Putih}, campur dengan {Kecap Manis}.<br>2. Lumuri {Tempe} dengan bumbu...', image_url: '/images/tempe-bakar.jpg', cooking_time_minutes: 25 },
  { id: 2, name: 'Opor Ayam Sehat (Tanpa Santan)', description: 'Versi lebih sehat dari opor tradisional...', instructions: '1. Tumis bumbu halus ({Kemiri}, {Bawang Putih}) hingga harum...', image_url: '/images/opor-sehat.jpg', cooking_time_minutes: 35 },
  { id: 3, name: 'Sayur Bening Bayam & Tahu Kukus', description: 'Makanan rumahan yang ringan, kaya serat dan nutrisi...', instructions: '1. Didihkan air, masukkan irisan bawang & temu kunci...', image_url: '/images/sayur-bening.jpg', cooking_time_minutes: 15 },
  { id: 4, name: 'Bubur Kacang Hijau Sehat', description: 'Sarapan hangat penuh serat dan energi...', instructions: '1. Rebus {Kacang Hijau} dengan daun pandan dan {Jahe} hingga empuk...', image_url: '/images/bubur-kacang.jpg', cooking_time_minutes: 45 },
  { id: 5, name: 'Sarapan Praktis Padat Gizi', description: 'Solusi sarapan super cepat di hari sibuk...', instructions: '1. Rebus {Telur Ayam} hingga matang.<br>2. Sajikan dengan {Pisang Ambon}.', image_url: '/images/pisang-telur.jpg', cooking_time_minutes: 10 },
  { id: 6, name: 'Tahu Orak-Arik Sayur', description: 'Menu sarapan atau makan malam tinggi protein nabati dan serat...', instructions: '1. Hancurkan {Tahu Putih Sutra}.<br>2. Tumis {Bawang Putih}, masukkan {Telur Ayam}, orak-arik...', image_url: '/images/tahu-orak-arik.jpg', cooking_time_minutes: 15 },
  { id: 7, name: 'Paket Soto Ayam Bening', description: 'Soto ayam versi ringan dan segar tanpa santan...', instructions: '1. Rebus {Dada Ayam Fillet} hingga matang, suwir-suwir...', image_url: '/images/soto-bening.jpg', cooking_time_minutes: 40 },
  { id: 8, name: 'Paket Urap Sayuran & Tempe', description: 'Salad tradisional Indonesia yang kaya rasa dan serat...', instructions: '1. Kukus semua sayuran ({Daun Bayam}, {Tauge}, {Buncis})...', image_url: '/images/urap-sayur.jpg', cooking_time_minutes: 30 },
  { id: 9, name: 'Roti Gandum Selai Kacang & Pisang', description: 'Sarapan ala barat yang praktis...', instructions: '1. Panggang {Roti Gandum}.<br>2. Oleskan {Selai Kacang (alami)}...', image_url: '/images/roti-selai.jpg', cooking_time_minutes: 5 },
];
